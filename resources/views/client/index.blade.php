...
@section('main-content')
    ...
    <div class="slider-area">
        <div class="slider-active owl-dot-style owl-carousel">
            <div class="single-slider ptb-240 bg-img" style="background-image:url({{ asset('assets/client/img/slider/slider-1.jpg)') }}">
                <div class="container">
            ...
            <div class="single-slider ptb-240 bg-img" style="background-image:url({{ asset('assets/client/img/slider/slider-1-1.jpg)') }}">
                <div class="container">
                    <div class="slider-content slider-animated-1">
                        <h1 class="animated">Want to stay <span class="theme-color">healthy</span></h1>
                        <h1 class="animated">drink matcha.</h1>
    ...
    <div class="product-area bg-image-1 pt-100 pb-95">
        <div class="container">
            <div class="featured-product-active hot-flower owl-carousel product-nav">
                ...
                <div class="product-wrapper border rounded shadow-sm p-3 mb-4 bg-white">
                    <div class="product-img position-relative">
                        <a href="product-details.html" class="d-block">
                            <img src="{{ asset('assets/client/img/product/product-1.jpg ') }}" alt="" class="img-fluid rounded">
                        </a>
                        <span>-50%</span>
                        <div class="product-action position-absolute bottom-0 start-0 end-0 text-center pb-3">
                            <a style="background-color: #519f10;" href="#" class="action-wishlist text-white me-2" title="Wishlist">
                                <i class="ion-android-favorite-outline"></i>
                            </a>
                            <a style="background-color: #519f10;" href="#" class="action-cart text-white me-2" title="Add To Cart">
                                <i class="ion-ios-shuffle-strong"></i>
                            </a>
                            <a style="background-color: #519f10;" href="#" class="action-compare text-white" data-bs-target="#exampleModal" data-bs-toggle="modal" title="Quick View">
                                <i class="ion-ios-search-strong"></i>
                            </a>
                        </div>
                    </div>
                    <div class="product-content text-center mt-3">
                        <h5 class="product-title mb-2">
                            <a href="product-details.html" class="text-dark text-decoration-none">Nature Close Tea</a>
                        </h5>
                        <div class="product-price-wrapper d-flex justify-content-center align-items-center">
                            <span class="fs-5 fw-bold me-2">$100.00</span>
                            <span class="product-price-old text-muted text-decoration-line-through">$120.00</span>
                        </div>
                ...
                <div class="product-wrapper">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img alt="" src="{{ asset('assets/client/img/product/product-2.jpg') }}">
                        </a>
                        <div class="product-action">
                            <a class="action-wishlist" href="#" title="Wishlist">
                                <i class="ion-android-favorite-outline"></i>
                ...
                <div class="product-wrapper">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img alt="" src="{{ asset('assets/client/img/product/product-3.jpg') }}">
                        </a>
                        <span>-50%</span>
                        <div class="product-action">
                            <a class="action-wishlist" href="#" title="Wishlist">
                ...
                <div class="product-wrapper">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img alt="" src="{{ asset('assets/client/img/product/product-4.jpg') }}">
                        </a>
                        <div class="product-action">
                            <a class="action-wishlist" href="#" title="Wishlist">
                                <i class="ion-android-favorite-outline"></i>
                ...
                <div class="product-wrapper">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img alt="" src="{{ asset('assets/client/img/product/product-5.jpg') }}">
                        </a>
                        <span>-30%</span>
                        <div class="product-action">
                            <a class="action-wishlist" href="#" title="Wishlist">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="single-banner img-zoom mb-30">
                            <a href="#">
                                <img src="{{ asset('assets/client/img/banner/banner-1.png') }}" alt="">
                            </a>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-banner img-zoom mb-30">
                            <a href="#">
                                <img src="{{ asset('assets/client/img/banner/banner-2.png') }}" alt="">
                            </a>
                            <div class="banner-content">
                                <h4>-20% Sale</h4>
                    ...
                    <div class="featured-product-active owl-carousel product-nav">
                        <div class="product-wrapper-single">
                            <div class="product-wrapper mb-30">
                                <div class="product-img">
                                    <a href="product-details.html">
                                        <img alt="" src="{{ asset('assets/client/img/product/product-1.jpg') }}">
                                    </a>
                                    <span>-30%</span>
                                    <div class="product-action">
                                        <a class="action-wishlist" href="#" title="Wishlist">
                        ...
                        <div class="product-wrapper-single">
                            ...
                            <div class="product-wrapper mb-30">
                                <div class="product-img">
                                    <a href="product-details.html">
                                        <img alt="" src="{{ asset('assets/client/img/product/product-6.jpg') }}">
                                    </a>
                                    <span>-40%</span>
                                    <div class="product-action">
                                        <a class="action-wishlist" href="#" title="Wishlist">
                        ...
                        <div class="product-wrapper-single">
                            <div class="product-wrapper mb-30">
                                <div class="product-img">
                                    <a href="product-details.html">
                                        <img alt="" src="{{ asset('assets/client/img/product/product-7.jpg') }}">
                                    </a>
                                    <span>-60%</span>
                                    <div class="product-action">
                                        <a class="action-wishlist" href="#" title="Wishlist">
                            ...
                            <div class="product-wrapper mb-30">
                                <div class="product-img">
                                    <a href="product-details.html">
                                        <img alt="" src="{{ asset('assets/client/img/product/product-8.jpg') }}">
                                    </a>
                                    <div class="product-action">
                                        <a class="action-wishlist" href="#" title="Wishlist">
                                            <i class="ion-android-favorite-outline"></i>
                    ...
                    <div class="testimonial-active owl-carousel">
                        <div class="single-testimonial text-center">
                            <div class="testimonial-img">
                                <img alt="" src="{{ asset('assets/client/img/icon-img/testi.png') }}">
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="blog-single mb-30">
                        <div class="blog-thumb">
                            <a href="#"><img src="{{ asset('assets/client/img/blog/blog-single-1.jpg') }}" alt="" /></a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-single mb-30">
                        <div class="blog-thumb">
                            <a href="#"><img src="{{ asset('assets/client/img/blog/blog-single-2.jpg') }}" alt="" /></a>
                        </div>
                        <div class="blog-content pt-25">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-single mb-30">
                        <div class="blog-thumb">
                            <a href="#"><img src="{{ asset('assets/client/img/blog/blog-single-3.jpg') }}" alt="" /></a>
                        </div>
                        <div class="blog-content pt-25">

            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <div class="product-details-img">
                        <img class="zoompro" src="{{ asset('assets/client/img/product-details/product-detalis-l1.jpg') }}"
                            data-zoom-image="{{ asset('assets/client/img/product-details/product-detalis-bl1.jpg') }}"
                            alt="zoom" />
                        <div id="gallery" class="mt-20 product-dec-slider owl-carousel">
                            <a data-image="{{ asset('assets/client/img/product-details/product-detalis-l1.jpg') }}"
                                data-zoom-image="{{ asset('assets/client/img/product-details/product-detalis-bl1.jpg') }}">
                                <img src="{{ asset('assets/client/img/product-details/product-detalis-s1.jpg') }}"
                                    alt="">
                            </a>
                            <a data-image="{{ asset('assets/client/img/product-details/product-detalis-l2.jpg') }}"
                                data-zoom-image="{{ asset('assets/client/img/product-details/product-detalis-bl2.jpg') }}">
                                <img src="{{ asset('assets/client/img/product-details/product-detalis-s2.jpg') }}"
                                    alt="">
                            </a>
                            <a data-image="{{ asset('assets/client/img/product-details/product-detalis-l3.jpg') }}"
                                data-zoom-image="{{ asset('assets/client/img/product-details/product-detalis-bl3.jpg') }}">
                                <img src="{{ asset('assets/client/img/product-details/product-detalis-s3.jpg') }}"
                                    alt="">
                            </a>
                            <a data-image="{{ asset('assets/client/img/product-details/product-detalis-l4.jpg') }}"
                                data-zoom-image="{{ asset('assets/client/img/product-details/product-detalis-bl4.jpg') }}">
                                <img src="{{ asset('assets/client/img/product-details/product-detalis-s4.jpg') }}"
                                    alt="">
                            </a>
                            <a data-image="{{ asset('assets/client/img/product-details/product-detalis-l5.jpg') }}"
                                data-zoom-image="{{ asset('assets/client/img/product-details/product-detalis-bl5.jpg') }}">
                                <img src="{{ asset('assets/client/img/product-details/product-detalis-s5.jpg') }}"
                                    alt="">
                            </a>
                            <a data-image="{{ asset('assets/client/img/product-details/product-detalis-l2.jpg') }}"
                                data-zoom-image="{{ asset('assets/client/img/product-details/product-detalis-bl2.jpg') }}">

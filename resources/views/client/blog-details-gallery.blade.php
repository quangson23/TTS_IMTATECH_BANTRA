                        ...
                        <div class="single-blog-wrapper">
                            ...
                            <div class="highlights-title-wrapper">
                                <div class="highlights-img">
                                    <img src="{{ asset('assets/client/img/blog/blog-link-post2.png') }}" alt="">
                                </div>
                            ...
                            <div class="dec-img-wrapper">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="dec-img">
                                            <img src="{{ asset('assets/client/img/blog/blog-dec-img1.jpg') }}"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="dec-img dec-mrg">
                                            <img src="{{ asset('assets/client/img/blog/blog-dec-img2.jpg') }}"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="administrator-wrapper">
                                <div class="administrator-img">
                                    <img src="{{ asset('assets/client/img/blog/blog-administrator.png') }}" alt="">
                                </div>
                        ...
                        <div class="blog-comment-wrapper mt-55">
                            ...
                            <div class="single-comment-wrapper mt-35">
                                <div class="blog-comment-img">
                                    <img src="{{ asset('assets/client/img/blog/blog-comment1.png') }}" alt="">
                                </div>
                            ...
                            <div class="single-comment-wrapper mt-50 ml-125">
                                <div class="blog-comment-img">
                                    <img src="{{ asset('assets/client/img/blog/blog-comment2.png') }}" alt="">
                                </div>
                                <div class="blog-comment-content">
                                    <h4>Anthony Stephens</h4>
                                    <span>October 14, 2022 </span>

                                ...
                                <tbody>
                                    <tr>
                                        <td class="product-thumbnail">
                                            <a href="#"><img src="{{ asset('assets/client/img/cart/cart-3.jpg') }}"
                                                    alt=""></a>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="product-thumbnail">
                                            <a href="#"><img src="{{ asset('assets/client/img/cart/cart-4.jpg') }}"
                                                    alt=""></a>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="product-thumbnail">
                                            <a href="#"><img src="{{ asset('assets/client/img/cart/cart-5.jpg') }}"
                                                    alt=""></a>
                                        </td>

            ...
            <div class="row blog-grid">
                    ...
                    <div class="single-blog-wrapper mb-40">
                        <div class="blog-img mb-30">
                            <a href="blog-details-standerd.html">
                                <img src="{{ asset('assets/client/img/blog/blog-masonry-1.jpg') }}" alt="">
                            </a>
                        </div>
                    ...
                    <div class="single-blog-wrapper mb-45">
                        <div class="quote-post">
                            <div class="quote-content">
                                ...
                                <h3><a href="blog-details-quote.html">Lorem ipsum dolor sit amet co adipisicing elit, sed do
                                        eiusmod tempor incididunt is labore et dolore magna aliqua.</a></h3>
                                <h6>Tasnim</h6>
                            </div>
                            <div class="post-img">
                ...
                <div class="col-lg-4 col-md-6 blog-grid-item">
                    <div class="single-blog-wrapper mb-40">
                        <div class="blog-img mb-30">
                            <a href="blog-details-standerd.html">
                                <img src="{{ asset('assets/client/img/blog/blog-masonry-2.jpg') }}" alt="">
                            </a>
                        </div>
                        <div class="blog-content">
                            <h2><a href="blog-details-standerd.html">Que Herbal Matcha Tea</a></h2>
                            <div class="blog-date-categori">
                                <ul>
                                    <li>October 14, 2022 </li>
                                    <li><a href="#">Admin </a></li>
                ...
                <div class="col-lg-4 col-md-6 blog-grid-item">
                    <div class="single-blog-wrapper mb-45">
                        <div class="blog-img mb-30">
                            <a href="blog-details-standerd.html">
                                <img src="{{ asset('assets/client/img/blog/blog-masonry-3.jpg') }}" alt="">
                            </a>
                        </div>
                        <div class="blog-content">
                            <h2><a href="blog-details-standerd.html">Green Tea Tulsi Time</a></h2>
                            <div class="blog-date-categori">
                                <ul>
                                    <li>October 14, 2022 </li>
                                    <li><a href="#">Admin </a></li>

...
<!-- Mirrored from htmldemo.net/sabujcha/sabujcha/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 Aug 2024 15:15:22 GMT -->
...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/client/assets/img/favicon.png') }}">
    ...
    <link rel="stylesheet" href="{{ asset('assets/client/css/chosen.min.css') }}">
                                    ...
                                    <ul>
                                        <li class="single-shopping-cart">
                                            <div class="shopping-cart-img">
                                                <a href="#"><img alt=""
                                                        src="{{ asset('assets/client/img/cart/cart-1.jpg') }}"></a>
                                            </div>
                                        ...
                                        <li class="single-shopping-cart">
                                            <div class="shopping-cart-img">
                                                <a href="#"><img alt=""
                                                        src="{{ asset('assets/client/img/cart/cart-2.jpg') }}"></a>
                                            </div>
                                            <div class="shopping-cart-title">
                                                <h4><a href="#">Phantom Remote</a></h4>
                                                <h6>Qty: 02</h6>
        ...
        <div class="footer-bottom pb-25 pt-25 gray-bg-2">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="copyright">
                            <p class="copy-text"> © 2022 <strong>SabujCha</strong> Made With <i class="fa fa-heart"
                    ...
                    <div class="col-md-6">
                        <div class="payment-img f-right">
                            <a href="#">
                                <img alt="" src="{{ asset('assets/client/img/icon-img/payment.png') }}">
                            </a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="product-thumbnail">
                                <div class="thumb-menu owl-carousel nav nav-style" role="tablist">
                                    <a class="active" data-bs-toggle="tab" href="#pro-1"><img
                                            src="{{ asset('assets/client/img/product-details/product-detalis-s1.jpg') }}"
                                            alt=""></a>
                                    <a data-bs-toggle="tab" href="#pro-2"><img
                                            src="{{ asset('assets/client/img/product-details/product-detalis-s2.jpg') }}"
                                            alt=""></a>
                                    <a data-bs-toggle="tab" href="#pro-3"><img
                                            src="{{ asset('assets/client/img/product-details/product-detalis-s3.jpg') }}"
                                            alt=""></a>
                                    <a data-bs-toggle="tab" href="#pro-4"><img
                                            src="{{ asset('assets/client/img/product-details/product-detalis-s4.jpg') }}"
                                            alt=""></a>
                                </div>
                            </div>
                            <!-- Thumbnail image end -->
...
<!-- Mirrored from htmldemo.net/sabujcha/sabujcha/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 Aug 2024 15:15:58 GMT -->
